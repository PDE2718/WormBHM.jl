@generated function worm_cycle_bb!(
    ...
    quote
        ...
        P_worm_action = 0.8
        P_move = P_worm_action * cycle_probs.move_worm
        P_insert_kink = P_worm_action * cycle_probs.insert_kink
        P_delete_kink = P_worm_action * cycle_probs.delete_kink
        P_glue = P_worm_action
        ...
        @inbounds for _ ∈ 1:n_cycle
            ...
            elseif dice < P_insert_kink  # [INSERT_KINK]
                # println("   inserting...")
                if loc ≠ _at_free
                    @goto CYCLE_START🔁
                end
            ...
            elseif dice < P_delete_kink  # [DELETE_KINK]
                # println("deleting...")
                if loc ≠ _at_kink
                    @goto CYCLE_START🔁
                end
