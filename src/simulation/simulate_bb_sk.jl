@generated function simulate_bb_sk!(
    x::Wsheet{Nw},
    H::Ham,
    ...
    Sk_boson::T_StructureFactorBoson=nothing,
    ...
    boson_snapshots::T_BosonSnaps=nothing,
        ...
        T_StructureFactorBoson <:Union{StructureFactorND,Nothing},
    ...
    return quote
        ...
        $(
            if T_StructureFactorBoson ≠ Nothing
                quote
                    Sk_plan_boson = rfftplan(Sk_boson)
                end
            end
        )
        ...
        while time_ns() < t_limit
            ...
            $(
                if T_StructureFactorBoson ≠ Nothing
                    quote
                        copy_states!(Sk_boson, H.bosons)
                        cal_Sk!(Sk_boson, Sk_plan_boson)
                    end
                end
            )
            $(
